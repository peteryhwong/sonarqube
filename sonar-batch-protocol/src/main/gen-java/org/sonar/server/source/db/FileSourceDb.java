...
public final class FileSourceDb {
  ...
  public interface TestOrBuilder extends
    ...
    /**
     * <code>repeated .org.sonar.server.source.db.Test.CoveredFile covered_file = 8;</code>
     */
  ...
  bitField0_ |= 0x00000001;
    ...
    public static final int COVERED_FILE_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < coveredFile_.size(); i++) {
        output.writeMessage(8, coveredFile_.get(i));
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < coveredFile_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, coveredFile_.get(i));
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSerializedSize = size;
      return size;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "us\030\004 \001(\0162\013.TestStatus\022\031\n\021execution_time_" +
      "ms\030\005 \001(\003\022\022\n\nstacktrace\030\006 \001(\t\022\013\n\003msg\030\007 \001(" +
      "\t\022B\n\014covered_file\030\010 \003(\0132,.org.sonar.serv" +
      "er.source.db.Test.CoveredFile\032:\n\013Covered" +
      "File\022\021\n\tfile_uuid\030\001 \001(\t\022\030\n\014covered_line\030",
      "\002 \003(\005B\002\020\001B\002H\001"
    };
    ...
    internal_static_org_sonar_server_source_db_Test_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_org_sonar_server_source_db_Test_descriptor,
        new java.lang.String[] { "Uuid", "Name", "Type", "Status", "ExecutionTimeMs", "Stacktrace", "Msg", "CoveredFile", });
    internal_static_org_sonar_server_source_db_Test_CoveredFile_descriptor =
